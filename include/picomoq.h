...
#define PMOQ_MSG_SUBSCRIBE_NAMESPACE       0x11
#define PMOQ_MSG_SUBSCRIBE_NAMESPACE_OK    0x12
#define PMOQ_MSG_SUBSCRIBE_NAMESPACE_ERROR 0x13
#define PMOQ_MSG_UNSUBSCRIBE_NAMESPACE     0x14
#define PMOQ_MSG_MAX_SUBSCRIBE_ID          0x15
#define PMOQ_MSG_CLIENT_SETUP         0x40
#define PMOQ_MSG_SERVER_SETUP         0x41

/* header types for streams and datagrams
 */

#define PMOQ_STRM_OBJECT_DATAGRAM      0x1
#define PMOQ_STRM_HEADER_TRACK  0x2
#define PMOQ_STRM_HEADER_SUBGROUP  0x4
...
#define PMOQ_OBJECT_STATUS_END_OF_SUBGROUP 0x5
#define PMOQ_OBJECT_STATUS_MAX 0x5

#define PMOQ_BIT_STRING_SIZE_MAX 8192
#define PMOQ_TUPLE_SIZE_MAX 32
...
typedef struct st_pmoq_tuple_t {
    uint64_t nb_items;
    pmoq_bits_t items[PMOQ_TUPLE_SIZE_MAX];
} pmoq_tuple_t;
...
#define PMOQ_SUBSCRIBE_ERROR_INTERNAL_ERROR 0
#define PMOQ_SUBSCRIBE_ERROR_INVALID_RANGE 1
#define PMOQ_SUBSCRIBE_ERROR_RETRY_TRACK_ALIAS 2
#define PMOQ_SUBSCRIBE_ERROR_TRACK_DOES_NOT_EXIST 3
#define PMOQ_SUBSCRIBE_ERROR_UNAUTHORIZED 4
#define PMOQ_SUBSCRIBE_ERROR_TIMEOUT 5
#define PMOQ_SUBSCRIBE_ERROR_MAX 5
...
uint8_t* pmoq_strm_header_track_format(uint8_t* bytes, const uint8_t* bytes_max, const pmoq_strm_t* object_header);
const uint8_t* pmoq_strm_header_track_parse(const uint8_t* bytes, const uint8_t* bytes_max, int* err, int needed, pmoq_strm_t* object_header);
